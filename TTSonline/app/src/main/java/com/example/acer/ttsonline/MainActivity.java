package com.example.acer.ttsonline;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String text = "请注意，前方有障碍物";
    private TextView text1;//接收python数据的text
    float i = 50;
    private static final int TCP_SERVER_PORT = 9996;
    //device var
...
//						etReceived.setText("");
    ...
    Runnable networkTask = new Runnable() {
        ...
        public void run() {
            try {
                Socket s = new Socket("10.20.87.199", TCP_SERVER_PORT);//注意host改成你服务器的hostname或IP地址
        ...
        public void Init()
    {
        ...
        etReceived=this.findViewById(R.id.editText2);
    }
